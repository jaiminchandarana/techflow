...
const getAdminEmailContent = (formData, inquiryId) => {
  ...
  const priority = priorityLevels[formData.budget] || { level: 'Medium', icon: '🟡', bgColor: '#f5f5f5', textColor: '#666666' };

  return `
    ${getEmailHeader()}
    
    <div style="padding: 40px 30px; background-color: #ffffff; font-family: 'Poppins', 'Calibri', sans-serif;">
      <div style="background: ${priority.bgColor}; padding: 20px; border-radius: 12px; margin-bottom: 25px; text-align: center; border: 1px solid #e0e0e0;">
        ...
        <p style="color: ${priority.textColor}; margin: 0; font-size: 14px; font-family: 'Poppins', sans-serif;">
          Priority: ${priority.level} | Inquiry ID: ${inquiryId}
        </p>
      </div>

      <div style="background: #fafafa; padding: 25px; border-radius: 12px; margin-bottom: 25px; border-left: 4px solid #333333;">
        <h3 style="color: #000000; margin: 0 0 20px 0; font-size: 18px; font-family: 'Poppins', sans-serif; font-weight: 600;">👤 Client Information</h3>
        <table style="width: 100%; border-collapse: collapse; font-family: 'Poppins', sans-serif;">
          <tr>
            <td style="padding: 8px 0; color: #666666; font-weight: 500; width: 25%;">Name:</td>
            <td style="padding: 8px 0; color: #000000; font-weight: 700;">${formData.name}</td>
          ...
          <tr>
            <td style="padding: 8px 0; color: #666666; font-weight: 500;">Phone:</td>
            <td style="padding: 8px 0; color: #333333;"><a href="tel:${formData.phone}" style="color: #2563eb; text-decoration: none;">${formData.phone || 'Not provided'}</a></td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666666; font-weight: 500;">Company:</td>
            <td style="padding: 8px 0; color: #333333;">${formData.company || 'Not provided'}</td>
          </tr>
        </table>
      </div>

      <div style="background: #ffffff; padding: 25px; border-radius: 12px; margin-bottom: 25px; border: 1px solid #e0e0e0;">
        <h3 style="color: #000000; margin: 0 0 20px 0; font-size: 18px; font-family: 'Poppins', sans-serif; font-weight: 600;">🎯 Project Details</h3>
        <table style="width: 100%; border-collapse: collapse; font-family: 'Poppins', sans-serif;">
          <tr>
            <td style="padding: 8px 0; color: #666666; font-weight: 500; width: 25%;">Service:</td>
            <td style="padding: 8px 0; color: #000000; font-weight: 700;">${formData.service}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666666; font-weight: 500;">Budget:</td>
            <td style="padding: 8px 0; color: #000000; font-weight: 700;">${formData.budget || 'Not specified'}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666666; font-weight: 500;">Timeline:</td>
            <td style="padding: 8px 0; color: #333333;">${formData.timeline || 'Not specified'}</td>
      ...
      <div style="background: #fafafa; padding: 25px; border-radius: 12px; margin-bottom: 25px; border: 1px solid #e0e0e0;">
        <h3 style="color: #000000; margin: 0 0 15px 0; font-size: 18px; font-family: 'Poppins', sans-serif; font-weight: 600;">📝 Project Description</h3>
        <div style="background: white; padding: 20px; border-radius: 8px; border: 1px solid #e0e0e0;">
          <p style="color: #333333; margin: 0; line-height: 1.6; font-size: 14px; font-family: 'Poppins', sans-serif;">
            ${formData.message}
          </p>
        </div>
      </div>
      ...
      <div style="background: #ffffff; padding: 25px; border-radius: 12px; margin-bottom: 25px; border: 1px solid #e0e0e0;">
        <h3 style="color: #000000; margin: 0 0 15px 0; font-size: 18px; font-family: 'Poppins', sans-serif; font-weight: 600;">📋 Additional Details</h3>
    ...
    <div style="padding: 40px 30px; background-color: #ffffff; font-family: 'Poppins', 'Calibri', sans-serif;">
      <div style="text-align: center; margin-bottom: 30px;">
        <div style="background: #f5f5f5; padding: 20px; border-radius: 12px; margin-bottom: 25px; border: 1px solid #e0e0e0;">
          ...
          <p style="color: #333333; margin: 0; font-size: 16px; font-family: 'Poppins', sans-serif;">
      ...
      <div style="background: #fafafa; padding: 25px; border-radius: 12px; margin-bottom: 30px; border-left: 4px solid #333333;">
        <h3 style="color: #000000; margin: 0 0 15px 0; font-size: 18px; font-family: 'Poppins', sans-serif; font-weight: 600;">📚 What to Expect</h3>
        <div style="space-y: 12px;">
          <div style="display: flex; align-items: start; margin-bottom: 12px;">
            <span style="background: #333333; color: white; border-radius: 50%; width: 24px; height: 24px; display: inline-flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; margin-right: 12px; flex-shrink: 0; font-family: 'Poppins', sans-serif;">1</span>
            <span style="color: #333333; font-size: 14px; line-height: 1.5; font-family: 'Poppins', sans-serif;">Weekly insights on AI, data analytics, and web development</span>
          </div>
          <div style="display: flex; align-items: start; margin-bottom: 12px;">
            <span style="background: #666666; color: white; border-radius: 50%; width: 24px; height: 24px; display: inline-flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; margin-right: 12px; flex-shrink: 0; font-family: 'Poppins', sans-serif;">2</span>
            <span style="color: #333333; font-size: 14px; line-height: 1.5; font-family: 'Poppins', sans-serif;">Exclusive tips and best practices from industry experts</span>
          </div>
          <div style="display: flex; align-items: start; margin-bottom: 12px;">
            <span style="background: #999999; color: white; border-radius: 50%; width: 24px; height: 24px; display: inline-flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; margin-right: 12px; flex-shrink: 0; font-family: 'Poppins', sans-serif;">3</span>
            <span style="color: #333333; font-size: 14px; line-height: 1.5; font-family: 'Poppins', sans-serif;">Early access to new services and special offers</span>
          </div>
        </div>
      </div>

      <div style="text-align: center; padding: 20px; background: #f5f5f5; border-radius: 12px;">
        <h3 style="color: #000000; margin: 0 0 15px 0; font-size: 16px; font-family: 'Poppins', sans-serif; font-weight: 600;">Explore Our Latest Content</h3>
        <a href="${process.env.WEBSITE_URL}/blog" style="background: #333333; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 500; display: inline-block; font-family: 'Poppins', sans-serif;">
          📖 Visit Our Blog
        </a>
      </div>
    </div>
